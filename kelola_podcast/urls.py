...
from .views import add_episode, add_podcast, list_podcast, podcast_detail, delete_podcast, delete_episode
...
urlpatterns = [
    ...
    path('add/', add_podcast, name='add_podcast'),
     ...
     path('episode/<uuid:id>/delete/', delete_episode, name='delete_episode')
]
